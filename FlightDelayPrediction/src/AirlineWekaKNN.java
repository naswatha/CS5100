 ...
 * Created by Karthik
 */
public class AirlineWekaKNN {

    public static void runWekaKNN(String[] args) throws Exception {
        if (args.length < 4) {
        ...
        job.setJarByClass(AirlineWekaKNN.class);
        ...
        job2.setJarByClass(AirlineWekaKNN.class);
        ...
        System.out.println("===================================================================");
        System.out.println("Validation Report with Confusion Matrix for k Nearest Neighbors using Weka:");
        System.out.println("===================================================================");
    ...
    */
    static class AirlineWekaReducer extends Reducer<IntWritable, AirlineCompositeKey, IntWritable, IntWritable> {
        ...
        public void reduce(IntWritable key, Iterable<AirlineCompositeKey> values, Context context) throws IOException, InterruptedException {
            ...
            try {
                // Build the KNN Classifier for the dataset
    ...
    static class AirlineWekaReducer2 extends Reducer<IntWritable, AirlineCompositeKey, Text, Text> {
        ...
        public void reduce(IntWritable key, Iterable<AirlineCompositeKey> values, Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                IBk knn = (IBk)objectInputStream.readObject();
                objectInputStream.close();

                // Classify each instance and write the result to the context
                for (int i=0;i<testDataset.numInstances();i++) {
                	double pred = knn.classifyInstance(testDataset.instance(i));
